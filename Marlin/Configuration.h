...
#define STRING_CONFIG_H_AUTHOR "Markus" // Who made the changes.
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -4.40 // Z offset: -below +above  [the nozzle]
...
#define DEFAULT_KEEPALIVE_INTERVAL 15  // Number of seconds between "busy" messages. Set with M113.
